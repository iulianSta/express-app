...
// Check entries
userMiddleware.checkUserData = (req, res, next) => {
  const { userName, userPass, age, fbw, email } = req.body;

  // We can do !userName or userName == null both are cool
...
// Check Age
userMiddleware.checkAge = (req, res, next) => {
  const { age } = req.body;
...
// Check fbw
userMiddleware.checkFbw = (req, res, next) => {
  const { fbw } = req.body;
...
// Display username
userMiddleware.userNameCapitalized = (req, res, next) => {
...
userMiddleware.toolStackArrSort = (req, res, next) => {
...
userMiddleware.strToNum = (req, res, next) => {
